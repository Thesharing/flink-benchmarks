...
public class ScheduleSinkTasksInBatchJobBenchmark extends SchedulingBenchmarkBase {
	...
	public static void main(String[] args) throws RunnerException {
		Options options = new OptionsBuilder()
				...
				.include(".*" + ScheduleSinkTasksInBatchJobBenchmark.class.getCanonicalName() + ".*")
				.build();
	...
	public void setupIteration() {
		initSchedulingTopology(ResultPartitionState.CONSUMABLE, ResultPartitionType.BLOCKING);
